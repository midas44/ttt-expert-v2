...
import { readYaml, readNumber, readString, readTestDataMode, type TestDataMode } from "@common/config/configUtils";
...
export class GlobalConfig {
  ...
  private readonly primary: AppConfig;
  private readonly secondary: readonly AppConfig[];

  constructor(primary: AppConfig = new TttConfig(), secondary: readonly AppConfig[] = []) {
    this.primary = primary;
    this.secondary = secondary;
    this.appUrl = primary.appUrl;

...
/**
 * PMT login page. PMT shares CAS SSO with TTT and CS (cas-demo.noveogroup.com),
 * so an existing session in the same browser context redirects past the
 * login form straight to the PMT dashboard. The fixture must check the
 ...
 * the live PMT UI — this is a stub seeded from the CS/TTT login flow.
 */
export class LoginPage {
  ...
  constructor(
    ...
    private readonly config: PmtConfig,
  ) {}

  /** Navigates to the PMT application URL. */

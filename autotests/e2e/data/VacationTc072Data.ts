...
/**
 * TC-VAC-072: Verify chart timeline navigation.
 * Needs any logged-in user; a department manager sees more employees.
 */
export class VacationTc072Data {
  ...
  static async create(
    ...
    if (mode === "static") return new VacationTc072Data();
    ...
    try {
      ...
      return new VacationTc072Data(row.login);
    } finally {
      await db.close();
    }
  }
  ...
  constructor(
    employeeLogin = process.env.VACATION_TC072_EMPLOYEE ?? "pvaynmaster",
  ) {

...
| 8 | Email dispatch batch | `test-docs/email/email.xlsx` | TC-EMAIL-001, TC-EMAIL-002, TC-EMAIL-003, TC-EMAIL-004, TC-EMAIL-005, TC-EMAIL-006 (TS-Email-CronDispatch) | n/a (Phase C gated off) |
| 9 | Email retention prune (> 30 days) | `test-docs/email/email.xlsx` | TC-EMAIL-007, TC-EMAIL-008, TC-EMAIL-009, TC-EMAIL-010, TC-EMAIL-011 (TS-Email-CronPrune) | n/a (Phase C gated off) |
...
| 22 | Statistic-report optimized sync | `test-docs/statistics/statistics.xlsx` | TC-STAT-077, TC-STAT-078, TC-STAT-079, TC-STAT-080, TC-STAT-081, TC-STAT-082, TC-STAT-083, TC-STAT-084 (TS-Stat-CronStatReportSync) | n/a (Phase C gated off) |
